...
try {
  ...
  const requiredConstraints = {
    ...
    JournalEntry_source_type_check: ["sourcetype", "char_length", ">= 1", "<= 80"],
    JournalEntry_source_id_check: ["sourceid", "char_length", ">= 1", "<= 160"],
    JournalEntry_idempotency_check: ["idempotencykey", ">= 8", "<= 160"],
    JournalEntry_payload_hash_check: ["payloadhash", "[0-9a-f]{64}"],
    JournalEntry_memo_check: ["memo", ">= 1", "<= 500"],
    ...
    JournalLine_description_check: ["description", ">= 1", "<= 300"],
