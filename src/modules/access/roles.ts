...
export const businessRoles: readonly BusinessRoleDefinition[] = [
  ...
  { key: "business.admin", label: "Business Administrator", description: "Operational administration without ownership transfer authority.", capabilities: allCapabilities },
  {
    ...
    label: "Accountant",
    description: "Accounting, banking, reports, purchases, sales, parties, catalog, files, and audit visibility.",
    capabilities: ["dashboard.view", "parties.view", "catalog.view", "files.view", "audit.view", "sales.view", "purchases.view", "banking.view", "banking.manage", "accounting.view", "accounting.manage", "inventory.view", "projects.view", "reports.view", "settings.view"],
  },
  {
    key: "business.sales",
    label: "Sales User",
    description: "Sales and customer workflow access without accounting administration.",
    capabilities: ["dashboard.view", "parties.view", "parties.manage", "catalog.view", "files.view", "files.manage", "sales.view", "sales.manage", "inventory.view", "projects.view", "reports.view"],
  },
  {
    key: "business.purchases",
    label: "Purchasing User",
    description: "Supplier, catalog, and purchase workflow access.",
    capabilities: ["dashboard.view", "parties.view", "parties.manage", "catalog.view", "catalog.manage", "files.view", "files.manage", "purchases.view", "purchases.manage", "inventory.view", "projects.view", "reports.view"],
  },
  { key: "business.inventory", label: "Inventory User", description: "Stock, item, and warehouse operations.", capabilities: ["dashboard.view", "parties.view", "catalog.view", "catalog.manage", "files.view", "files.manage", "inventory.view", "inventory.manage", "sales.view", "purchases.view", "reports.view"] },
  { key: "business.project-manager", label: "Project Manager", description: "Project and job delivery with related commercial visibility.", capabilities: ["dashboard.view", "parties.view", "parties.manage", "catalog.view", "files.view", "files.manage", "projects.view", "projects.manage", "sales.view", "purchases.view", "inventory.view", "reports.view"] },
