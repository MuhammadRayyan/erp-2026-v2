...
export const moduleRegistry: readonly ErpModule[] = [
  ...
  { key: "accounting", label: "Accounting", group: "finance", href: "/business/accounting", description: "Chart of accounts and accounting-kernel foundations", entitlement: "accounting.core", permission: "accounting.view", phase: 4, status: "foundation" },
