    ...
    <div>
      ...
      <div className="mt-6 grid gap-4 xl:grid-cols-[1.5fr_1fr]">
        <Card>
          ...
          <p className="mt-1 text-sm text-[var(--muted)]">Approvals, overdue documents, failed jobs, and operational tasks will use one shared queue pattern.</p>
        ...
        <Card>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li>✓ Route and layout boundaries</li>
            <li>✓ Module capability registry</li>
