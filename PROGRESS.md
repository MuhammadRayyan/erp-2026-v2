...
1. Add custom-field definitions and values.
2. Add durable queued email records when the PostgreSQL outbox worker is introduced.

## Active blockers

- None for the verified reusable export foundation.
